        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    @endif
                    {!! Form::model($data['experiment'], ['route' => ['experiments.update', $data['experiment']->id]]) !!}
                        <h3>General Info</h3>
                        @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('phase', $data['selects']['phases'], null, array('class' => 'form-control', 'value'=>'{{ old("phase") }}')) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('Due Date') !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('bs_impact', $data['selects']['percentages'], null, array('class' => 'form-control', 'value'=>'{{ old("bs_impact") }}')) !!}
                        </div>
                        <div class="form-group">
                            ...
                            {!! Form::select('bs_confidence', $data['selects']['percentages'], null, array('class' => 'form-control', 'value'=>'{{ old("bs_confidence") }}')) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('How much effort will it take?') !!}
                            <small>How much effort will it take to ship this test and run it.</small>
                            {!! Form::select('bs_effort', $data['selects']['efforts'], null, array('class' => 'form-control', 'value'=>'{{ old("bs_effort") }}')) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            {!! Form::label('Priority') !!}
                            {!! Form::select('pr_priority', $data['selects']['priorities'], null, array('class' => 'form-control', 'value'=>'{{ old("pr_priority") }}')) !!}
                        </div>
                        <hr>
                        <h3>Build</h3>
                        <div class="form-group">
